    ...
    <nav className="fixed top-0 left-0 w-full bg-gray-900 duration-300 h-16 flex items-center p-3 z-10">
      <div className="w-full max-w-screen-xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center">
          <button
            onClick={onAddCourse}
            className="bg-indigo-500 text-white font-bold py-2 px-4 rounded hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 flex items-center"
          >
